...
\begin{itemize}
    ...
    \textit{proximity to obstacles, proximity to the goal, proximity to the path pro-
    duced by the global planner and speed} and it discards illegal trajectories
