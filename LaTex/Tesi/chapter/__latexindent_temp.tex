...
techniques: Greedy Strategy Single robot Single task (GS1:1), which is 
a baseline greedy approach, Set Partition Strategy Single robot Multiple task 
(SPS1:N) and Coalition formation Strategy Single robot Multiple task (CFS1:N),
...
our task assignment approaches with previous  methods mentioned.
\newline
\newline
